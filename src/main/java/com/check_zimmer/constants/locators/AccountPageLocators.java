...
public class AccountPageLocators {
    ...
    public static final String REGISTRATION_BUTTON = "//a[@href='/registration' and text()='Anmeldung']";
    public static final String CITY = "//a[@class='price-block-item' and .//div[@class='max-price' and text()='Leipzig']]";
